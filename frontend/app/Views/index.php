    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <p class="text-small fs-6 text-muted">Berikut adalah..</p>
            </nav>
    ...
    <div class="container-fluid py-4">
        <div class="row mt-4">
            <div class="col-lg-4 mb-lg-0 mb-4">
                <div class="card">
                    <div class="card-header border-bottom py-2 font-weight-bold">
                        Aktifitas Terakhir Anda
                    </div>
                    <div class="card-body p-3">
                        <div class="d-flex flex-column h-100">

                            <div class="d-flex">
                                <span style="width: 50px; height: 20px; font-size: 10px;" class="bg-primary rounded text-white text-center me-2">12:00</span>
                                <p class="text-muted" style="font-size: 12px">From colors, cards, typography .</p>
                            </div>
                            <div class="d-flex">
                                <span style="width: 50px; height: 20px; font-size: 10px;" class="bg-primary rounded text-white text-center me-2">12:00</span>
                                <p class="text-muted" style="font-size: 12px">From colors, cards, typography .</p>
